...
use EasyBaiDu\Kernel\Contracts\MessageInterface;
use EasyBaiDu\Kernel\Exceptions\BadRequestException;
use EasyBaiDu\Kernel\Exceptions\InvalidArgumentException;
use EasyBaiDu\Kernel\Messages\Message;
use EasyBaiDu\Kernel\Messages\News;
use EasyBaiDu\Kernel\Messages\NewsItem;
use EasyBaiDu\Kernel\Messages\Raw as RawMessage;
use EasyBaiDu\Kernel\Messages\Text;
use EasyBaiDu\Kernel\Support\XML;
use EasyBaiDu\Kernel\Traits\Observable;
...
class ServerGuard
{
     ...
     * @return $this
     *
     * @throws \EasyBaiDu\Kernel\Exceptions\BadRequestException
     */
     ...
     * Get request message.
     *
     * @return array|\EasyBaiDu\Kernel\Support\Collection|object|string
     *
     * @throws BadRequestException
     * @throws \EasyBaiDu\Kernel\Exceptions\InvalidArgumentException
     * @throws \EasyBaiDu\Kernel\Exceptions\InvalidConfigException
     ...
     * @param string                                                   $to
     * @param string                                                   $from
     * @param \EasyBaiDu\Kernel\Contracts\MessageInterface|string|int $message
     *
     * @return string
     *
     * @throws \EasyBaiDu\Kernel\Exceptions\InvalidArgumentException
     ...
     * @param string                                        $to
     * @param string                                        $from
     * @param \EasyBaiDu\Kernel\Contracts\MessageInterface $message
     *
     * @return string
     */
