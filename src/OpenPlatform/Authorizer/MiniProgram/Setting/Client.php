...
namespace EasyBaiDu\OpenPlatform\Authorizer\MiniProgram\Setting;
...
class Client extends BaseClient
{
     ...
     * 获取小程序全类目列表.
     */
    public function getAllCategories($category_type = 2)
    {
     ...
     */
    public function updateCategory(array $categorys)
    {
        return $this->httpPostJson('rest/2.0/smartapp/app/category/update', $categorys);
    }
